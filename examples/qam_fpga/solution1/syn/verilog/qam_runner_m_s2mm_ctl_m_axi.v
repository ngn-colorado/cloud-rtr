...
module qam_runner_m_s2mm_ctl_m_axi
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
...
//------------------------Instantiation------------------
// qam_runner_m_s2mm_ctl_m_axi_write
qam_runner_m_s2mm_ctl_m_axi_write #(
...
// qam_runner_m_s2mm_ctl_m_axi_read
qam_runner_m_s2mm_ctl_m_axi_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_TARGET_ADDR     ( C_TARGET_ADDR ),
...
module qam_runner_m_s2mm_ctl_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module qam_runner_m_s2mm_ctl_m_axi_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
...
module qam_runner_m_s2mm_ctl_m_axi_read
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------Instantiation------------------
// qam_runner_m_s2mm_ctl_m_axi_read_data_align 
qam_runner_m_s2mm_ctl_m_axi_read_data_align #(
    .C_DATA_WIDTH       (C_DATA_WIDTH),
...
qam_runner_m_s2mm_ctl_m_axi_fifo  #(
...
module qam_runner_m_s2mm_ctl_m_axi_read_data_align
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// qam_runner_m_s2mm_ctl_m_axi_reg_slice
...
module qam_runner_m_s2mm_ctl_m_axi_write
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
