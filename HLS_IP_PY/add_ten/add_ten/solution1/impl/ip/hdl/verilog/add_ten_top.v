...
wire [32 - 1:0] sig_add_ten_input_r;
wire [32 - 1:0] sig_add_ten_output_r;



add_ten add_ten_U(
    .input_r(sig_add_ten_input_r),
    .output_r(sig_add_ten_output_r),
    .ap_start(ap_start),
    .ap_ready(ap_ready),
    .ap_done(ap_done),
    .ap_idle(ap_idle),
...
add_ten_AXI4LiteS_if #(
    .C_ADDR_WIDTH(C_S_AXI_AXI4LITES_ADDR_WIDTH),
    .C_DATA_WIDTH(C_S_AXI_AXI4LITES_DATA_WIDTH))
add_ten_AXI4LiteS_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_input_r(sig_add_ten_input_r),
    .O_output_r(sig_add_ten_output_r),
