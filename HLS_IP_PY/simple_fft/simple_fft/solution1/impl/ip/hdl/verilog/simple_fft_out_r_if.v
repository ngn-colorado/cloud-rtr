...
module simple_fft_out_r_if (
    ...
    // User signals
    input  wire [31:0] out_r_din,
    output wire        out_r_full_n,
    input  wire        out_r_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
wire [0:0]  fifo_empty_n;
wire [31:0] out_r_dout;
wire [0:0]  out_r_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
// out_r_fifo
simple_fft_out_r_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) out_r_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( out_r_empty_n ),
    .full_n     ( out_r_full_n ),
    .read       ( fifo_read ),
    .write      ( out_r_write ),
    .dout       ( out_r_dout ),
...
assign s_data  = {out_r_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = out_r_empty_n;
...
module simple_fft_out_r_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
