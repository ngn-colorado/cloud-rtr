; ModuleID = 'C:/Users/Ali/Documents/Research/HLS_IP/add_five/add_five/solution1/.autopilot/db/a.g.1.bc'
...
@str = internal constant [9 x i8] c"add_five\00"  ; [#uses=1 type=[9 x i8]*]

; [#uses=0]
define i32 @add_five(i32* %input, i32* %output) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32 0) nounwind, !map !13
  call void (...)* @_ssdm_op_SpecTopModule([9 x i8]* @str) nounwind
  call void @llvm.dbg.value(metadata !{i32* %input}, i64 0, metadata !19), !dbg !20 ; [debug line = 1:19] [debug variable = input]
  call void @llvm.dbg.value(metadata !{i32* %output}, i64 0, metadata !21), !dbg !22 ; [debug line = 1:31] [debug variable = output]
  ...
  %output.assign = add nsw i32 %input.load, 5, !dbg !27 ; [#uses=1 type=i32] [debug line = 11:2]
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"C:/Users/Ali/Documents/Research/HLS_IP/add_five/add_five/solution1/.autopilot/db/add_five.pragma.2.cpp", metadata !"c:/Users/Ali/Documents/Research/HLS_IP/add_five", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !1} ; [ DW_TAG_compile_unit ]
!1 = metadata !{metadata !2}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{metadata !5}
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"add_five", metadata !"add_five", metadata !"_Z8add_fivePiS_", metadata !6, i32 1, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32*, i32*)* @add_five, null, null, metadata !11, i32 2} ; [ DW_TAG_subprogram ]
!6 = metadata !{i32 786473, metadata !"add_five.cpp", metadata !"c:/Users/Ali/Documents/Research/HLS_IP/add_five", null} ; [ DW_TAG_file_type ]
