...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_in_V_V_TDATA", 128, hls_in, 8, "axis", "in_data", 1),
	Port_Property("s_in_V_V_TVALID", 1, hls_in, 8, "axis", "in_vld", 1),
	Port_Property("s_in_V_V_TREADY", 1, hls_out, 8, "axis", "in_acc", 1),
	Port_Property("s_out_V_V_TDATA", 128, hls_out, 9, "axis", "out_data", 1),
	Port_Property("s_out_V_V_TVALID", 1, hls_out, 9, "axis", "out_vld", 1),
	Port_Property("s_out_V_V_TREADY", 1, hls_in, 9, "axis", "out_acc", 1),
