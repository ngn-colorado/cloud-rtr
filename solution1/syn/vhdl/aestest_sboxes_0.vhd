...
entity aestest_sboxes_0_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of aestest_sboxes_0_rom is 
...
architecture arch of aestest_sboxes_0 is
    component aestest_sboxes_0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aestest_sboxes_0_rom_U :  component aestest_sboxes_0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
