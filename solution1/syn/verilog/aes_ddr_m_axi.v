...
module aes_ddr_m_axi_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
...
module aes_ddr_m_axi_read_data_align
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
