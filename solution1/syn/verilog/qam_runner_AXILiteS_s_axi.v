...
localparam
    ...
    ADDR_DESTINATIONADDRESS_DATA_0     = 7'h20,
    ADDR_DESTINATIONADDRESS_CTRL       = 7'h24,
    ADDR_ITERATIONS_DATA_0             = 7'h28,
    ADDR_ITERATIONS_CTRL               = 7'h2c,
    ADDR_CONTROL_IN_QAM_DATA_0         = 7'h30,
    ADDR_CONTROL_IN_QAM_CTRL           = 7'h34,
    ADDR_CONTROL_IN_LF_P_DATA_0        = 7'h38,
    ADDR_CONTROL_IN_LF_P_CTRL          = 7'h3c,
    ADDR_CONTROL_IN_LF_I_DATA_0        = 7'h40,
    ADDR_CONTROL_IN_LF_I_CTRL          = 7'h44,
    ADDR_CONTROL_IN_LF_OUT_GAIN_DATA_0 = 7'h48,
    ADDR_CONTROL_IN_LF_OUT_GAIN_CTRL   = 7'h4c,
    ADDR_CONTROL_IN_REG_CLR_DATA_0     = 7'h50,
    ADDR_CONTROL_IN_REG_CLR_CTRL       = 7'h54,
    ADDR_CONTROL_IN_REG_INIT_DATA_0    = 7'h58,
    ADDR_CONTROL_IN_REG_INIT_CTRL      = 7'h5c;
...
reg  [31:0]          int_iterations;
reg                  int_iterations_ap_vld;
...
assign iterations_ap_vld             = int_iterations_ap_vld;
...
// int_iterations_ap_vld
always @(posedge ACLK) begin
    if (~ARESETN)
        int_iterations_ap_vld <= 1'b0;
    else if (w_hs && waddr == ADDR_ITERATIONS_CTRL && WSTRB[0] && WDATA[0])
        int_iterations_ap_vld <= 1'b1;
    else
        int_iterations_ap_vld <= 1'b0; // self clear
end
