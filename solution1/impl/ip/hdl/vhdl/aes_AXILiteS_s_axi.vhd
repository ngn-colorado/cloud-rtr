...
architecture behave of aes_AXILiteS_s_axi is
    ...
    constant ADDR_KEY_IN_V_DATA_0 : INTEGER :=16#20#;
    constant ADDR_KEY_IN_V_DATA_1 : INTEGER :=16#24#;
...
begin
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ar_hs = '1') then
                ...
                when ADDR_KEY_IN_V_DATA_0 =>
                    rdata_data <= RESIZE(int_key_in_V(31 downto 0), 32);
                when ADDR_KEY_IN_V_DATA_1 =>
                    rdata_data <= RESIZE(int_key_in_V(63 downto 32), 32);
                when ADDR_KEY_IN_V_DATA_2 =>
                    rdata_data <= RESIZE(int_key_in_V(95 downto 64), 32);
                when ADDR_KEY_IN_V_DATA_3 =>
    ...
    begin
        if (ACLK'event and ACLK = '1') then
             if (w_hs = '1' and waddr = ADDR_KEY_IN_V_DATA_0) then
                 int_key_in_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_key_in_V(31 downto 0));
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
             if (w_hs = '1' and waddr = ADDR_KEY_IN_V_DATA_1) then
                 int_key_in_V(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_key_in_V(63 downto 32));
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
             if (w_hs = '1' and waddr = ADDR_KEY_IN_V_DATA_2) then
                 int_key_in_V(95 downto 64) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_key_in_V(95 downto 64));
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
             if (w_hs = '1' and waddr = ADDR_KEY_IN_V_DATA_3) then
                 int_key_in_V(127 downto 96) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_key_in_V(127 downto 96));
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
             if (ARESETN = '0') then
                 int_key_in_V_ap_vld <= '0';
             elsif (w_hs  = '1' and waddr = ADDR_KEY_IN_V_CTRL and WSTRB(0) = '1' and WDATA(0) = '1') then
                 int_key_in_V_ap_vld <= '1';
             else
                 int_key_in_V_ap_vld <= '0'; -- self clear
            end if;
        end if;
    end process;
