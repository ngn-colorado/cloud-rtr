...
module aes_m_s2mm_ctl_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module aes_m_s2mm_ctl_m_axi_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
...
module aes_m_s2mm_ctl_m_axi_read
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------Instantiation------------------
// aes_m_s2mm_ctl_m_axi_read_data_align 
aes_m_s2mm_ctl_m_axi_read_data_align #(
    .C_DATA_WIDTH       (C_DATA_WIDTH),
...
module aes_m_s2mm_ctl_m_axi_read_data_align
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// aes_m_s2mm_ctl_m_axi_reg_slice
...
module aes_m_s2mm_ctl_m_axi_write
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
