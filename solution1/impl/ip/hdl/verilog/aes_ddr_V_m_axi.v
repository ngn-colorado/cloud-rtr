...
module aes_ddr_V_m_axi_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
...
//------------------------Instantiation------------------
// aes_ddr_V_m_axi_read_data_align 
aes_ddr_V_m_axi_read_data_align #(
    .C_DATA_WIDTH       (C_DATA_WIDTH),
...
module aes_ddr_V_m_axi_read_data_align
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
