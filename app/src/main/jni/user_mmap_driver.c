...
shared_memory getSharedMemoryArea(unsigned sharedMemoryAddress, unsigned length){
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "ndktest_jni", "TEST-preopendevmem!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
	/* Open /dev/mem file */
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "ndktest_jni", "TEST-postopendevmem!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
...
shared_memory getUioMemoryArea(char* file){
	unsigned page_addr, page_offset;
	//get page size from system
	unsigned page_size=sysconf(_SC_PAGESIZE);
	unsigned mmap_length = page_size;
