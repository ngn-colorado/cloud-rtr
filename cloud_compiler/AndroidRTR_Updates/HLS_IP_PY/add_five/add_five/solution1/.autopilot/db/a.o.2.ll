; ModuleID = 'C:/Users/Ali/Documents/Research/HLS_IP/add_five/add_five/solution1/.autopilot/db/a.o.2.bc'
...
define i32 @add_five(i32* %input, i32* %output) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %input}, i64 0, metadata !29), !dbg !30 ; [debug line = 1:19] [debug variable = input]
  call void @llvm.dbg.value(metadata !{i32* %output}, i64 0, metadata !31), !dbg !32 ; [debug line = 1:31] [debug variable = output]
  ...
  %output.assign = add nsw i32 %input.load, 5, !dbg !37 ; [#uses=1 type=i32] [debug line = 11:2]
