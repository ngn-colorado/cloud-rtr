...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-1180-Ali-PC/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-1180-Ali-PC/realtime/system_xfft_0_0_synth.xdc
    rt::sdcChecksum
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-1180-Ali-PC/"
    if {$rt::useElabCache == false} {
