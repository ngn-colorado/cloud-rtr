...
#Additional parts for testing purposes
#EVENTUALLY REMOVE THIS SECTION
#set_property ip_repo_paths  {c:/Users/Ali/Documents/Research/GPU_bitstream/test_gpu_2/library C:/Users/Ali/Documents/Research/HLS_IP_PY} [current_fileset]
#update_ip_catalog
#startgroup
#create_bd_cell -type ip -vlnv xilinx.com:hls:add_five:1.0 add_five_0
#endgroup
#startgroup
#create_bd_cell -type ip -vlnv xilinx.com:hls:add_five:1.0 add_five_1
#endgroup
#startgroup
#create_bd_cell -type ip -vlnv xilinx.com:hls:reset_axi:1.0 reset_axi_0
#endgroup
#apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/sys_ps7/M_AXI_GP0" Clk "Auto" }  [get_bd_intf_pins add_five_0/S_AXI_AXI4LITES]
#apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/sys_ps7/M_AXI_GP0" Clk "Auto" }  [get_bd_intf_pins add_five_1/S_AXI_AXI4LITES]
#apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/sys_ps7/M_AXI_GP0" Clk "Auto" }  [get_bd_intf_pins reset_axi_0/S_AXI_AXI4LITES]
#disconnect_bd_net /sys_100m_resetn [get_bd_pins add_five_0/aresetn]
#disconnect_bd_net /sys_100m_resetn [get_bd_pins add_five_1/aresetn]
#connect_bd_net [get_bd_pins reset_axi_0/reset_out] [get_bd_pins add_five_1/aresetn]
#connect_bd_net -net [get_bd_nets reset_axi_0_reset_out] [get_bd_pins add_five_0/aresetn] [get_bd_pins reset_axi_0/reset_out]
