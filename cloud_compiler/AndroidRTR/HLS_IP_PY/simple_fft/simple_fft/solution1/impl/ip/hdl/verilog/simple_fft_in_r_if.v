...
module simple_fft_in_r_if (
    ...
    // User signals
    output wire [31:0] in_r_dout,
    output wire        in_r_empty_n,
    input  wire        in_r_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
...
// in_r_fifo
simple_fft_in_r_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) in_r_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( in_r_empty_n ),
    .full_n     ( in_r_full_n ),
    .read       ( in_r_read ),
    .write      ( fifo_write ),
    .dout       ( in_r_dout ),
...
assign in_r_din    = m_data[31:0];
assign fifo_full_n = in_r_full_n;
...
module simple_fft_in_r_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
