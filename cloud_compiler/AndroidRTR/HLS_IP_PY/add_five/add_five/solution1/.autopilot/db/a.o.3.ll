; ModuleID = 'C:/Users/Ali/Documents/Research/HLS_IP/add_five/add_five/solution1/.autopilot/db/a.o.3.bc'
...
define i32 @add_five(i32* %input, i32* %output) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %input}, i64 0, metadata !16), !dbg !25 ; [debug line = 1:19] [debug variable = input]
  call void @llvm.dbg.value(metadata !{i32* %output}, i64 0, metadata !26), !dbg !27 ; [debug line = 1:31] [debug variable = output]
  ...
  %output_assign = add nsw i32 %input_read, 5, !dbg !32 ; [#uses=1 type=i32] [debug line = 11:2]
...
!17 = metadata !{i32 786478, i32 0, metadata !18, metadata !"add_five", metadata !"add_five", metadata !"_Z8add_fivePiS_", metadata !18, i32 1, metadata !19, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32*, i32*)* @add_five, null, null, metadata !23, i32 2} ; [ DW_TAG_subprogram ]
!18 = metadata !{i32 786473, metadata !"add_five.cpp", metadata !"c:/Users/Ali/Documents/Research/HLS_IP/add_five", null} ; [ DW_TAG_file_type ]
