...
proc init_gui { IPINST } {
	...
	set PCORE_QUAD_DUAL_N [ipgui::add_param $IPINST -parent $Page0 -name PCORE_QUAD_DUAL_N]
...
proc update_PARAM_VALUE.PCORE_QUAD_DUAL_N { PARAM_VALUE.PCORE_QUAD_DUAL_N } {
	# Procedure called to update PCORE_QUAD_DUAL_N when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PCORE_QUAD_DUAL_N { PARAM_VALUE.PCORE_QUAD_DUAL_N } {
	# Procedure called to validate PCORE_QUAD_DUAL_N
	return true
}
...
proc update_MODELPARAM_VALUE.PCORE_QUAD_DUAL_N { MODELPARAM_VALUE.PCORE_QUAD_DUAL_N PARAM_VALUE.PCORE_QUAD_DUAL_N } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PCORE_QUAD_DUAL_N}] ${MODELPARAM_VALUE.PCORE_QUAD_DUAL_N}
}
