...
proc init_gui { IPINST } {
	...
	set PCORE_DEVTYPE [ipgui::add_param $IPINST -parent $Page0 -name PCORE_DEVTYPE]
...
proc update_PARAM_VALUE.PCORE_DEVTYPE { PARAM_VALUE.PCORE_DEVTYPE } {
	# Procedure called to update PCORE_DEVTYPE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PCORE_DEVTYPE { PARAM_VALUE.PCORE_DEVTYPE } {
	# Procedure called to validate PCORE_DEVTYPE
	return true
}
...
proc update_MODELPARAM_VALUE.PCORE_DEVTYPE { MODELPARAM_VALUE.PCORE_DEVTYPE PARAM_VALUE.PCORE_DEVTYPE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PCORE_DEVTYPE}] ${MODELPARAM_VALUE.PCORE_DEVTYPE}
}
