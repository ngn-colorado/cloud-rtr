...
proc init_gui { IPINST } {
	...
	set S_READY_ENABLE [ipgui::add_param $IPINST -parent $Page0 -name S_READY_ENABLE]
...
proc update_PARAM_VALUE.S_READY_ENABLE { PARAM_VALUE.S_READY_ENABLE } {
	# Procedure called to update S_READY_ENABLE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.S_READY_ENABLE { PARAM_VALUE.S_READY_ENABLE } {
	# Procedure called to validate S_READY_ENABLE
	return true
}
...
proc update_MODELPARAM_VALUE.S_READY_ENABLE { MODELPARAM_VALUE.S_READY_ENABLE PARAM_VALUE.S_READY_ENABLE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.S_READY_ENABLE}] ${MODELPARAM_VALUE.S_READY_ENABLE}
}
